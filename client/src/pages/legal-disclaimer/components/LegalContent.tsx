export default function LegalContent() {
  return (
    <section className="py-20 px-8 md:px-16 lg:px-32 max-w-7xl mx-auto">
      <div className="space-y-12">
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">I. Legal</h3>
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">II. Use</h3>
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">III. Copyright</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">IV. Trademarks</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">V. Links to Third Party Sites</h3>
          <p className="text-gray-700 leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">VI. No Unlawful or Prohibited Use</h3>
          <p className="text-gray-700 leading-relaxed">
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">VII. Disclaimer</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <div>
          <h3 className="text-2xl font-bold text-orange-500 mb-4">VIII. Governing Law</h3>
          <p className="text-gray-700 leading-relaxed">

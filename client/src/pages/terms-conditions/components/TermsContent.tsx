  ...
  return (
    <section className="py-20 px-6 lg:px-20 max-w-7xl mx-auto">
      <div className="space-y-12">
        ...
        <div>
          <h2 className="text-3xl font-bold text-orange-500 mb-6">RELATIONSHIP BETWEEN PARTIES</h2>
          <p className="text-gray-700 leading-relaxed text-base">
        ...
        <div>
          <h2 className="text-3xl font-bold text-orange-500 mb-6">LIABILITY</h2>
